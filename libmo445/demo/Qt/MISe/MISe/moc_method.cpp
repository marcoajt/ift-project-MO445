...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Method_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Method_t qt_meta_stringdata_Method = {
    {
QT_MOC_LITERAL(0, 6) // "Method"
...
const QMetaObject Method::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Method.offsetsAndSize,
    qt_meta_data_Method,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Method_t
, QtPrivate::TypeAndForceComplete<Method, std::true_type>
