...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Brain_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Brain_t qt_meta_stringdata_Brain = {
    {
QT_MOC_LITERAL(0, 5), // "Brain"
QT_MOC_LITERAL(6, 8), // "generate"
QT_MOC_LITERAL(15, 0) // ""
...
const QMetaObject Brain::staticMetaObject = { {
    ...
    qt_meta_stringdata_Brain.offsetsAndSize,
    qt_meta_data_Brain,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Brain_t
, QtPrivate::TypeAndForceComplete<Brain, std::true_type>
...
void *Brain::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Brain.stringdata0))
