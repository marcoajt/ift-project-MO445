...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Marker_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Marker_t qt_meta_stringdata_Marker = {
    {
QT_MOC_LITERAL(0, 6) // "Marker"
...
const QMetaObject Marker::staticMetaObject = { {
    ...
    qt_meta_stringdata_Marker.offsetsAndSize,
    qt_meta_data_Marker,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Marker_t
, QtPrivate::TypeAndForceComplete<Marker, std::true_type>
