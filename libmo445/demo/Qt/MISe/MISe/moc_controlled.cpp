...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Controlled_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Controlled_t qt_meta_stringdata_Controlled = {
    {
QT_MOC_LITERAL(0, 10) // "Controlled"
...
const QMetaObject Controlled::staticMetaObject = { {
    QMetaObject::SuperData::link<Segmentation::staticMetaObject>(),
    qt_meta_stringdata_Controlled.offsetsAndSize,
    qt_meta_data_Controlled,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Controlled_t
, QtPrivate::TypeAndForceComplete<Controlled, std::true_type>
