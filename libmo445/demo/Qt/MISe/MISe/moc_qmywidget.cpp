...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QMyWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QMyWidget_t qt_meta_stringdata_QMyWidget = {
    {
QT_MOC_LITERAL(0, 9), // "QMyWidget"
QT_MOC_LITERAL(10, 19), // "WidgetDoubleClicked"
QT_MOC_LITERAL(30, 0) // ""

    },
    "QMyWidget\0WidgetDoubleClicked\0"
};
...
void QMyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QMyWidget *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->WidgetDoubleClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QMyWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QMyWidget::WidgetDoubleClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QMyWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_QMyWidget.offsetsAndSize,
    qt_meta_data_QMyWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_QMyWidget_t
, QtPrivate::TypeAndForceComplete<QMyWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void QMyWidget::WidgetDoubleClicked()
{
