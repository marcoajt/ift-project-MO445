...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyComboBox_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MyComboBox_t qt_meta_stringdata_MyComboBox = {
    {
QT_MOC_LITERAL(0, 10), // "MyComboBox"
QT_MOC_LITERAL(11, 11), // "itemClicked"
QT_MOC_LITERAL(23, 0), // ""
QT_MOC_LITERAL(24, 5) // "index"

    },
    "MyComboBox\0itemClicked\0\0index"
};
...
void MyComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyComboBox::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyComboBox::itemClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyComboBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyComboBox.offsetsAndSize,
    qt_meta_data_MyComboBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyComboBox_t
, QtPrivate::TypeAndForceComplete<MyComboBox, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void MyComboBox::itemClicked(int _t1)
{
