...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MyPlainTextEdit_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MyPlainTextEdit_t qt_meta_stringdata_MyPlainTextEdit = {
    {
QT_MOC_LITERAL(0, 15), // "MyPlainTextEdit"
QT_MOC_LITERAL(16, 12), // "focusChanged"
QT_MOC_LITERAL(29, 0) // ""

    },
    "MyPlainTextEdit\0focusChanged\0"
};
...
void MyPlainTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyPlainTextEdit *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPlainTextEdit::focusChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyPlainTextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_MyPlainTextEdit.offsetsAndSize,
    qt_meta_data_MyPlainTextEdit,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MyPlainTextEdit_t
, QtPrivate::TypeAndForceComplete<MyPlainTextEdit, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void MyPlainTextEdit::focusChanged()
{
