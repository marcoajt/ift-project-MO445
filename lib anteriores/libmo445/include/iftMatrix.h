...
/**
 * @brief Obtains the min value for one matrix column
 * @author Azael Sousa
 * @date Nov 21, 2022
 * @param matrix input matrix.
 * @param c column.
...
/**
 * @brief Obtains the min value for one matrix row
 * @author Azael Sousa
 * @date Nov 21, 2022
 * @param matrix input matrix.
 * @param r row
 ...
 * @return
 */
void iftSumMatricesInPlace( iftMatrix* m1,  iftMatrix* m2, iftMatrix* sum);

iftMatrix* iftSubtractMatrices( iftMatrix* m1,  iftMatrix* m2);
void iftSubtractMatricesInPlace( iftMatrix* m1,  iftMatrix* m2, iftMatrix* sub);
