...
npts_per_marker = 1 # Linha adicionada
line = "bag_of_feature_points filtered markers {} bag".format(npts_per_marker) #Linha adicionada
os.system(line) #Linha adicionada
